...
def make_parser():
    ...
    parser.add_argument("-c",
                        ...
                        type=str,
                        required=False,
                        default='{"algorithm_params":{"triton_url":"192.168.113.57:30740"},"algorithm":"parabolic-detection","consumer_topic":"coverall_detection","producer_topic":"capture_scene","pulsar_address":"pulsar://192.168.113.71:6650","log":{"log_path":"/app/log","log_file":"parabolic-detection","log_rotation":"1 week","log_retention":"3 week"}}',
